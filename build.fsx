...
let author = "David Zimmer"

// Tags for your project (for NuGet package)
let tags = "proteomics FSharp"

// File system information
let solutionFile  = "QConQuantifier.sln"
...
let gitOwner = "ZimmerD"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "QConQuantifier"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/ZimmerD"

let website = "/QConQuantifier"
...
let info =
  [ "project-name", "QConQuantifier"
    "project-author", "David Zimmer"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/QConQuantifier" ]
